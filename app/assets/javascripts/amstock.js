...
AmCharts.Cuboid = AmCharts.Class({
	...
	draw: function() {
		...
		var q, t, u, v, w, B, z, C, x;
		if (0 < e || 0 < f) z = s, s = AmCharts.adjustLuminosity(p, -0.2), s = AmCharts.adjustLuminosity(p, -0.2), q = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, f, f, 0, 0], s, h, 0, 0, 0, n), 0 < m && (x = AmCharts.line(b, [0, e, c + e], [0, f, f], l, m, k)), t = AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], s, h, 0, 0, 0, 0, n), t.translate(e, f), 0 < m && (u = AmCharts.line(b, [e, e], [f, f + d], l, 1, k)), v = AmCharts.polygon(b, [0, 0, e, e, 0], [0, d, d + f, f, 0], s, h, 0, 0, 0, n), w = AmCharts.polygon(b, [c, c, c + e, c + e, c], [0, d, d + f, f, 0], s, h, 0, 0, 0, n), 0 < m && (B = AmCharts.line(b, [c, c + e, c + e, c], [0, f, d + f, d], l, m, k)), s = AmCharts.adjustLuminosity(z, 0.2), z = AmCharts.polygon(b, [0, e, c + e, c, 0], [d, d + f, d + f, d, d], s, h, 0, 0, 0, n), 0 < m && (C = AmCharts.line(b, [0, e, c + e], [d, d + f, d + f], l, m, k));
		1 > Math.abs(d) && (d = 0);
		1 > Math.abs(c) && (c = 0);
		b = 0 === d ? AmCharts.line(b, [0, c], [0, 0], l, m, k) : 0 === c ? AmCharts.line(b, [0, 0], [0, d], l, m, k) : 0 < r ? AmCharts.rect(b, c, d, g, h, k, l, m, r, n) : AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], g, h, k, l, m, n);
		d = 0 > d ? [q, x, t, u, v, w, B, z, C, b] : [z, C, t, u, v, w, q, x, B, b];
...
AmCharts.AmLegend = AmCharts.Class({
	...
	arrangeEntries: function() {
		...
		for (v = 0; v < t.length; v++) {
			var C = t[v];
			this.reversedOrder && (C = t[t.length - v - 1]);
			u = C.getBBox();
			var x;
			this.equalWidths ? x = f + B * (r + m + this.markerLabelGap) : (x = z, z = z + u.width + f + m);
			x + u.width > n && (0 < v && 0 != B) && (w++, B = 0, x = f, z = x + u.width + f + m, skipNewRow = !0);
			C.translate(x, (p + l) * w);
			B++;
			!isNaN(k) && B >= k && (B = 0, w++);
			s.push(C)
	...
	draw: function() {
		...
		if (!isNaN(a)) {
			...
			if (this.show) {
				...
				f.push(d);
				var B;
				void 0 != m && (B = AmCharts.text(e, this.text, m, v, w, c, !1, 0.4), f.push(B));
				v = d.getBBox();
				m = v.height + 2 * n;
				v = v.width + 2 * s;
				window.opera && (m += 2);
				...
				d.translate(z, w);
				B && B.translate(z + 1, w + 1);
				"H" != t ? (z = a - v / 2, c = b < h + m + 10 && "down" != t ? b + q : b - m - q) : (2 * q > m && (q = m / 2), c = b - m / 2, z = a < g + (k - g) / 2 ? a + q : a - v - q);
				c + m >= l && (c = l - m);
				c < h && (c = h);
				z < g && (z = g);
				z + v > k && (z = k - v);
				0 < u || 0 === q ? (p = AmCharts.rect(e, v, m, r, this.fillAlpha, this.borderThickness, p, this.borderAlpha, this.cornerRadius), this.showBullet && (e = AmCharts.circle(e, this.bulletSize, r, this.fillAlpha), e.translate(a, b), this.pointer = e)) : (l = [], u = [], "H" != t ? (g = a - z, g > v - q && (g = v - q), g < q && (g = q), l = [0, g - q, a - z, g + q, v, v, 0, 0], u = b < h + m + 10 && "down" != t ? [0, 0, b - c, 0, 0, m, m, 0] : [m, m, b - c, m, m, 0, 0, m]) : (h = b - c, h > m - q && (h = m - q), h < q && (h = q), u = [0, h - q, b - c, h + q, m, m, 0, 0], l = a < g + (k - g) / 2 ? [0, 0, z < a ? 0 : a - z, 0, 0, v, v, 0] : [v, v, z + v > a ? v : a - z, v, v, 0, 0, v]), p = AmCharts.polygon(e, l, u, r, this.fillAlpha, this.borderThickness, p, this.borderAlpha));
				f.push(p);
				p.toFront();
				B && B.toFront();
				d.toFront();
				...
				for (t = 0; t < q.length; t++) {
					...
					for (v = 0; v < a.length; v++) {
						...
						if (b.valueAxis.id == u) {
							...
							z.index = r;
							b.dataProvider && (s = c);
							z.values = this.processValues(s, b, B);
							this.processFields(b, z, s);
...
AmCharts.TrendLine = AmCharts.Class({
	...
	draw: function() {
		...
		var b = a.chart,
			...
			t = a.initialValue,
			u = a.finalValue,
			v = r.recalculateToPercents;
		h && (k && (d = h.dateToCoordinate(k)), l && (d = h.categoryToCoordinate(l)), m && (e = h.dateToCoordinate(m)), n && (e = h.categoryToCoordinate(n)));
		p && !v && (isNaN(s) || (d = p.getCoordinate(s)), isNaN(q) || (e = p.getCoordinate(q)));
		r && !v && (isNaN(t) || (f = r.getCoordinate(t)), isNaN(u) || (g = r.getCoordinate(u)));
		...
		if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
			...
			if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
				...
				if (0 < B) {
					...
					for (d = this.fillAlpha = 0; d < B; d++) {
						var C = w[d],
							x = NaN,
							y = C.above;
						isNaN(C.toValue) || (x = this.getCoordinate(C.toValue), v = new this.axisItemRenderer(this, x, "", !0, NaN, NaN, C), this.pushAxisItem(v, y));
						var A = NaN;
						isNaN(C.value) || (A = this.getCoordinate(C.value), v = new this.axisItemRenderer(this, A, C.label, !0, NaN, (x - A) / 2, C), this.pushAxisItem(v, y));
						isNaN(x - A) || (v = new this.guideFillRenderer(this, A, x, C), this.pushAxisItem(v, y), v = v.graphics(), C.graphics = v, C.balloonText && this.addEventListeners(v, C))
					}
					this.fillAlpha = z
				}
				w = !1;
				for (d = p; d < s; d += r) v = AmCharts.roundTo(this.step * d + this.min, c), -1 != String(v).indexOf("e") && (w = !0, String(v).split("e"));
				...
				for (d = p; d < s; d += r) if (p = this.step * d + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p) if (isNaN(t) || Number(AmCharts.toFixed(p, t)) == p) {
					...
					w ? (v = -1 == String(p).indexOf("e") ? p.toExponential(15) : String(p), v = v.split("e"), c = Number(v[0]), v = Number(v[1]), c = AmCharts.roundTo(c, 14), 10 == c && (c = 1, v += 1), v = c + "e" + v, 0 === p && (v = "0"), 1 == p && (v = "1")) : (h && (c = String(p).split("."), u.precision = c[1] ? c[1].length : -1), v = this.usePrefixes ? AmCharts.addPrefix(p, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, u, !0) : AmCharts.formatNumber(p, u, u.precision));
					this.duration && (v = AmCharts.formatDuration(p, this.duration, "", this.durationUnits, this.maxInterval, u));
					this.recalculateToPercents ? v += "%" : (c = this.unit) && (v = "left" == this.unitPosition ? c + v : v + c);
					Math.round(d / l) != d / l && (v = void 0);
					if (0 === d && !m || d == s - 1 && !n) v = " ";
					c = this.getCoordinate(p);
					this.labelFunction && (v = this.labelFunction(p, v, this));
					...
					if (p == this.baseValue && "radar" != k) {
						var F, J, B = this.viW,
							...
							p = this.viX;
						v = this.viY;
						"H" == this.orientation ? 0 <= c && c <= B + 1 && (F = [c, c, c + e], J = [z, 0, f]) : 0 <= c && c <= z + 1 && (F = [0, B, B + e], J = [c, c, c + f]);
						F && (c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), c = AmCharts.line(a.container, F, J, this.gridColor, c, 1, this.dashLength), c.translate(p, v), this.grid0 = c, a.axesSet.push(c), c.toBack())
					}
				}
				d = this.baseValue;
	...
	draw: function() {
		...
		if (AmCharts.ifArray(a)) {
			...
			var t = this.firstDayOfWeek,
				...
				a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * l), this.minPeriod, 1, t).getTime(),
				v;
			...
			if (this.parseDates && !this.equalSpacing) {
				...
				var g = Math.ceil(this.timeDifference / r) + 1,
					w = m = AmCharts.resetDateToMin(new Date(this.startTime - r), e, n, t).getTime();
				...
				if (0 < this.gridCount) for (b = d; b <= g; b++) {
					...
					v = !1;
					q && this.markPeriodChange ? (m = this.dateFormatsObject[this.nextPeriod[p]], v = !0) : m = this.dateFormatsObject[p];
					u || (v = !1);
					m = AmCharts.formatDate(new Date(a), m);
					if (b == d && !h || b == g && !k) m = " ";
					this.labelFunction && (m = this.labelFunction(m, new Date(a), this));
					m = new this.axisItemRenderer(this, l, m, !1, s, 0, !1, v);
					this.pushAxisItem(m);
					m = a
				}
			} else if (!this.parseDates) {
				if (this.cellWidth = this.getStepWidth(b), b < g && (g = b), f += this.start, this.stepWidth = this.getStepWidth(b), 0 < g) for (u = Math.floor(b / g), l = f, l / 2 == Math.round(l / 2) && l--, 0 > l && (l = 0), g = 0, b = l; b <= this.end + 2; b++) if (0 <= b && b < this.data.length ? (p = this.data[b], m = p.category) : m = "", b / u == Math.round(b / u) || p.forceShow) {
					l = this.getCoordinate(b - f);
					t = 0;
					"start" == this.gridPosition && (l -= this.cellWidth / 2, t = this.cellWidth / 2);
				...
				for (b = l; b < s; b++) if (a = this.data[b].time, this.checkPeriodChange(e, n, a, m)) {
					...
					m = AmCharts.formatDate(new Date(a), m);
					if (b == d && !h || b == g && !k) m = " ";
					r ? r = !1 : (u || (v = !1), l - this.previousPos > this.safeDistance * Math.cos(this.labelRotation * Math.PI / 180) && (this.labelFunction && (m = this.labelFunction(m, new Date(a), this)), m = new this.axisItemRenderer(this, l, m, void 0, void 0, void 0, void 0, v), t = m.graphics(), this.pushAxisItem(m), this.previousPos = l + t.getBBox().width));
					m = a
				}
			}
			...
			for (b = 0; b < h; b++) k = this.guides[b], t = t = t = g = u = NaN, d = k.above, k.toCategory && (t = c.getCategoryIndexByValue(k.toCategory), isNaN(t) || (u = this.getCoordinate(t - f), m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k), this.pushAxisItem(m, d))), k.category && (t = c.getCategoryIndexByValue(k.category), isNaN(t) || (g = this.getCoordinate(t - f), t = (u - g) / 2, m = new this.axisItemRenderer(this, g, k.label, !0, NaN, t, k), this.pushAxisItem(m, d))), k.toDate && (this.equalSpacing ? (t = c.getClosestIndex(this.data, "time", k.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(t) || (u = this.getCoordinate(t - f))) : u = (k.toDate.getTime() - this.startTime) * this.stepWidth, m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k), this.pushAxisItem(m, d)), k.date && (this.equalSpacing ? (t = c.getClosestIndex(this.data, "time", k.date.getTime(), !1, 0, this.data.length - 1), isNaN(t) || (g = this.getCoordinate(t - f))) : g = (k.date.getTime() - this.startTime) * this.stepWidth, t = (u - g) / 2, m = "H" == this.orientation ? new this.axisItemRenderer(this, g, k.label, !1, 2 * t, NaN, k) : new this.axisItemRenderer(this, g, k.label, !1, NaN, t, k), this.pushAxisItem(m, d)), u = new this.guideFillRenderer(this, g, u, k), g = u.graphics(), this.pushAxisItem(u, d), k.graphics = g, g.index = b, k.balloonText && this.addEventListeners(g, k)
		}
		this.axisCreated = !0;
		c = this.x;
		f = this.y;
...
AmCharts.RecItem = AmCharts.Class({
	construct: function(a, b, c, d, e, f, g, h, k) {
		...
		var s = a.axisThickness,
			...
			W = a.offset,
			ma, X;
		g ? (y = !0, isNaN(g.tickLength) || (u = g.tickLength), void 0 != g.lineColor && (B = g.lineColor), void 0 != g.color && (n = g.color), isNaN(g.lineAlpha) || (v = g.lineAlpha), isNaN(g.dashLength) || (z = g.dashLength), isNaN(g.lineThickness) || (w = g.lineThickness), !0 === g.inside && (J = !0), isNaN(g.labelRotation) || (A = g.labelRotation), isNaN(g.fontSize) || (m = g.fontSize), g.position && (da = g.position)) : "" === c && (u = 0);
		X = "start";
		e && (X = "middle");
		var Y = A * Math.PI / 180,
			ka, I = 0,
		...
		"V" == Fa && (A = 0);
		var U;
		y && (U = AmCharts.text(r, c, n, l, m, X, h), ga = U.getBBox().width);
		if ("H" == Fa) {
			if (0 <= b && b <= R + 1 && (0 < u && (0 < t && b + k <= R + 1) && (ma = AmCharts.line(r, [b + k, b + k], [0, u], q, t, w), p.push(ma)), 0 < v && (X = AmCharts.line(r, [b, b + S, b + S], [T, T + Q, Q], B, v, w, z), p.push(X))), D = 0, I = b, g && 90 == A && (I -= m), !1 === d ? (X = "start", D = "bottom" == da ? J ? D + u : D - u : J ? D - u : D + u, I += 3, e && (I += e / 2, X = "middle"), 0 < A && (X = "middle")) : X = "middle", 1 == F && (0 < x && !g && ha < R) && (d = AmCharts.fitToBounds(b, 0, R), ha = AmCharts.fitToBounds(ha, 0, R), ka = d - ha, 0 < ka && (fill = AmCharts.rect(r, ka, a.height, C, x), fill.translate(d - ka + S, Q), p.push(fill))), "bottom" == da ? (D += T + m / 2 + W, J ? 0 < A ? (D = T - ga / 2 * Math.sin(Y) - u - 3, I += ga / 2 * Math.cos(Y)) : D -= u + m + 3 + 3 : 0 < A ? (D = T + ga / 2 * Math.sin(Y) + u + 3, I -= ga / 2 * Math.cos(Y)) : D += u + s + 3 + 3) : (D += Q + m / 2 - W, I += S, J ? 0 < A ? (D = ga / 2 * Math.sin(Y) + u + 3, I -= ga / 2 * Math.cos(Y)) : D += u + 3 : 0 < A ? (D = -(ga / 2) * Math.sin(Y) - u - 6, I += ga / 2 * Math.cos(Y)) : D -= u + m + 3 + s + 3), "bottom" == da ? ka = (J ? T - u - 1 : T + s - 1) + W : ($ = S, ka = (J ? Q : Q - u - s + 1) - W), f && (I += f), Q = I, 0 < A && (Q += ga / 2 * Math.cos(Y)), U && (da = 0, J && (da = ga / 2 * Math.cos(Y)), Q + da > R + 2 || 0 > Q)) U.remove(), U = null
		} else {
			0 <= b && b <= T + 1 && (0 < u && (0 < t && b + k <= T + 1) && (ma = AmCharts.line(r, [0, u], [b + k, b + k], q, t, w), p.push(ma)), 0 < v && (X = AmCharts.line(r, [0, S, R + S], [b, b + Q, b + Q], B, v, w, z), p.push(X)));
			X = "end";
			if (!0 === J && "left" == da || !1 === J && "right" == da) X = "start";
			D = b - m / 2;
			1 == F && (0 < x && !g) && (d = AmCharts.fitToBounds(b, 0, T), ha = AmCharts.fitToBounds(ha, 0, T), Y = d - ha, fill = AmCharts.polygon(r, [0, a.width, a.width, 0], [0, 0, Y, Y], C, x), fill.translate(S, d - Y + Q), p.push(fill));
			D += m / 2;
			"right" == da ? (I += S + R + W, D += Q, J ? (I -= u + 4, f || (D -= m / 2 + 3)) : (I += u + 4 + s, D -= 2)) : J ? (I += u + 4 - W, f || (D -= m / 2 + 3), g && (I += S, D += Q)) : (I += -u - s - 4 - 2 - W, D -= 2);
			ma && ("right" == da ? ($ += S + W + R, ka += Q, $ = J ? $ - s : $ + s) : ($ -= W, J || ($ -= u + s)));
			f && (D += f);
			J = -3;
			"right" == da && (J += Q);
			U && (D > T + 1 || D < J) && (U.remove(), U = null)
		}
		ma && ma.translate($, ka);
		!1 === a.visible && (ma && ma.remove(), U && (U.remove(), U = null));
		U && (U.attr({
			"text-anchor": X
		}), U.translate(I, D), 0 !== A && U.rotate(-A), a.allLabels.push(U), " " != c && (this.label = U));
		a.counter = 0 === F ? 1 : 0;
		a.previousCoord = b;
...
AmCharts.RadItem = AmCharts.Class({
	construct: function(a, b, c, d, e, f, g) {
		...
		f = a.x;
		var A = a.y;
		g ? (B = !0, isNaN(g.tickLength) || (p = g.tickLength), void 0 != g.lineColor && (t = g.lineColor), isNaN(g.lineAlpha) || (s = g.lineAlpha), isNaN(g.dashLength) || (u = g.dashLength), isNaN(g.lineThickness) || (q = g.lineThickness), !0 === g.inside && (z = !0)) : c || (s /= 3, p /= 2);
		var F = "end",
			J = -1;
		z && (F = "start", J = 1);
		var S;
		B && (S = AmCharts.text(m, c, l, h, k, F), S.translate(f + (p + 3) * J, b), d.push(S), this.label = S, y = AmCharts.line(m, [f, f + p * J], [b, b], n, r, q), d.push(y));
		b = a.y - b;
		c = [];
		h = [];
		if (0 < s) {
			if ("polygons" == C) {
				x = a.data.length;
				for (k = 0; k < x; k++) l = 180 - 360 / x * k, c.push(b * Math.sin(l / 180 * Math.PI)), h.push(b * Math.cos(l / 180 * Math.PI));
				c.push(c[0]);
				h.push(h[0]);
				s = AmCharts.line(m, c, h, t, s, q, u)
		...
		if (1 == e && 0 < w && !g) {
			g = a.previousCoord;
			if ("polygons" == C) {
				for (k = x; 0 <= k; k--) l = 180 - 360 / x * k, c.push(g * Math.sin(l / 180 * Math.PI)), h.push(g * Math.cos(l / 180 * Math.PI));
				x = AmCharts.polygon(m, c, h, v, w)
			} else x = AmCharts.wedge(m, 0, 0, 0, -360, b, b, g, 0, {
				fill: v,
				"fill-opacity": w,
				stroke: 0,
				"stroke-opacity": 0,
...
AmCharts.AmGraph = AmCharts.Class({
	...
	createSerialGraph: function() {
		var a = this.chart,
			...
			q = [],
			t = [],
			u, v, w, B, z = this.chart.graphs.length,
			C, x = this.dx / this.depthCount,
		...
		var ka = F,
			I = 270;
		"horizontal" == this.gradientOrientation && (I = 0);
		this.gradientRotation = I;
		var D = this.chart.columnSpacing,
			$ = Fa.cellWidth,
			ga = ($ * h - r) / r;
		D > ga && (D = ga);
		var U, H, Qa, Ya = l + 1,
		...
		if (!Q && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Ga || void 0 != ya)) {
			...
			n ? (Ya = l, Za = Math.abs(qb - ua), ab = l, bb = Math.abs(Ua - ua), Ta = $a = 0, f.reversed ? (Ra = 0, Sa = ua) : (Ra = ua, Sa = 0)) : (Za = k, Ya = Math.abs(qb - ua), bb = k, ab = Math.abs(Ua - ua), Sa = Ra = 0, f.reversed ? (Ta = m, $a = ua) : Ta = ua + 1)
		}
		var va = Math.round;
		this.pmx = va(Ra);
		this.pmy = va($a);
		...
		h = "column" == g ? ($ * h - D * (r - 1)) / r : $ * h;
		1 > h && (h = 1);
		var O;
		if ("line" == g || "step" == g || "smoothedLine" == g) {
			if (0 < J) for (O = J - 1; - 1 < O; O--) if (U = d[O], H = U.axes[f.id].graphs[b], Qa = H.values.value, !isNaN(Qa)) {
				J = O;
				break
			}
			if (S < d.length - 1) for (O = S + 1; O < d.length; O++) if (U = d[O], H = U.axes[f.id].graphs[b], Qa = H.values.value, !isNaN(Qa)) {
				S = O;
				break
			}
		}
		...
		var ea = [],
			fa = [],
			Ja = !1;
		if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == A || "100%" == A || this.fillToGraph) Ja = !0;
		for (O = J; O <= S; O++) {
			U = d[O];
			H = U.axes[f.id].graphs[b];
			H.index = O;
			var L, M, K, aa, na = NaN,
				G = NaN,
				E = NaN,
				...
				qa = ma,
				ja, ra;
			void 0 != H.color && (wa = H.color);
			H.fillColors && (wa = H.fillColors);
			isNaN(H.alpha) || (Ma = H.alpha);
			var sa = H.values;
			f.recalculateToPercents && (sa = H.percents);
			if (sa) {
				V = this.stackable && "none" != A && "3d" != A ? sa.close : sa.value;
				...
				Q || (H.x = na); - 1E5 > na && (na = -1E5);
				na > k + 1E5 && (na = k + 1E5);
				n ? (G = E, P = N, N = E = na, isNaN(ia) && !this.fillToGraph && (P = da), Ka = za, La = Aa) : (P = G = na, isNaN(ia) && !this.fillToGraph && (N = da));
				V < ia && (H.isNegative = !0, Ga && (wa = Ga), Ia && (Ma = Ia), void 0 != ya && (qa = ya));
				switch (g) {
				case "line":
					isNaN(V) ? s || (this.drawLineGraph(q, t, ea, fa), q = [], t = [], ea = [], fa = []) : (H.isNegative = V < ha ? !0 : !1, q.push(G), t.push(E), Z = G, ca = E, oa = G, pa = E, !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P), fa.push(N)));
					break;
				case "smoothedLine":
					isNaN(V) ? s || (this.drawSmoothedGraph(q, t, ea, fa), q = [], t = [], ea = [], fa = []) : (H.isNegative = V < ha ? !0 : !1, q.push(G), t.push(E), Z = G, ca = E, oa = G, pa = E, !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P), fa.push(N)));
					break;
				case "step":
					isNaN(V) ? s || (v = NaN, this.drawLineGraph(q, t, ea, fa), q = [], t = [], ea = [], fa = []) : (H.isNegative = V < ha ? !0 : !1, n ? (isNaN(u) || (q.push(u), t.push(E - ta)), t.push(E - ta), q.push(G), t.push(E + Na), q.push(G), !Ja || (isNaN(N) || isNaN(P)) || (ea.push(w), fa.push(N - ta), ea.push(P), fa.push(N - ta), ea.push(P), fa.push(N + Na))) : (isNaN(v) || (t.push(v), q.push(G - ta)), q.push(G - ta), t.push(E), q.push(G + Na), t.push(E), !Ja || (isNaN(N) || isNaN(P)) || (ea.push(P - ta), fa.push(B), ea.push(P - ta), fa.push(N), ea.push(P + Na), fa.push(N))), u = G, v = E, w = P, B = N, Z = G, ca = E, oa = G, pa = E);
					break;
				case "column":
					ja = qa;
					void 0 != H.lineColor && (ja = H.lineColor);
					if (!isNaN(V)) {
						V < ha ? (H.isNegative = !0, Ga && (wa = Ga), void 0 != ya && (ja = ya)) : H.isNegative = !1;
						var rb = f.min,
							sb = f.max;
						if (!(V < rb && ia < rb || V > sb && ia > sb)) if (n) {
							"3d" == A ? (M = E - 0.5 * (h + D) + D / 2 + y * T, L = P + x * T) : (M = E - (r / 2 - T) * (h + D) + D / 2, L = P);
							K = h;
							Z = G;
							ca = M + h / 2;
							oa = G;
							...
							aa += Fb - L;
							aa = AmCharts.fitToBounds(aa, -L, k - L + x * T);
							if (M < l && 0 < K && (la = new AmCharts.Cuboid(e, aa, K, x - a.d3x, y - a.d3y, wa, Ma, R, ja, W, I, p, n), "bottom" != F)) if (F = f.reversed ? "left" : "right", 0 > V) F = f.reversed ? "right" : "left";
							else if ("regular" == A || "100%" == A) Z += this.dx
						} else {
							"3d" == A ? (L = G - 0.5 * (h + D) + D / 2 + x * T, M = N + y * T) : (L = G - (r / 2 - T) * (h + D) + D / 2, M = N);
							K = h;
							Z = L + h / 2;
							ca = E;
							oa = L + h / 2;
							...
							aa += Gb - M;
							aa = AmCharts.fitToBounds(aa, -M + y * T, l - M);
							if (L < k + T * x && 0 < K) if (la = new AmCharts.Cuboid(e, K, aa, x - a.d3x, y - a.d3y, wa, Ma, R, ja, this.lineAlpha, I, p, n), 0 > V && "middle" != F) F = "bottom";
							else if (F = ka, "regular" == A || "100%" == A) ca += this.dy
						}
						if (la && (ra = la.set, ra.translate(L, M), this.columnsSet.push(ra), (H.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), !Q)) {
							"none" == A && (C = n ? (this.end + 1 - O) * z - c : z * O + c);
							"3d" == A && (n ? (C = (z - c) * (this.end + 1 - O), Z += x * this.columnIndex, oa += x * this.columnIndex, H.y += x * this.columnIndex) : (C = (z - c) * (O + 1), Z += 3, ca += y * this.columnIndex + 7, pa += y * this.columnIndex, H.y += y * this.columnIndex));
							if ("regular" == A || "100%" == A) F = "middle", C = n ? 0 < sa.value ? (this.end + 1 - O) * z + c : (this.end + 1 - O) * z - c : 0 < sa.value ? z * O + c : z * O - c;
							...
							this.animateColumns(la, O, G, P, E, N);
							this.addListeners(ra, H)
						}
					}
					break;
				case "candlestick":
					if (!isNaN(ia) && !isNaN(V)) {
						...
						void 0 != H.lineColor && (ja = H.lineColor);
						if (n) {
							if (M = E - h / 2, L = P, K = h, M + K > l && (K = l - M), 0 > M && (K += M, M = 0), M < l && 0 < K) {
								var fb, gb;
								V > ia ? (fb = [G, La], gb = [P, Ka]) : (fb = [P, La], gb = [G, Ka]);
								!isNaN(La) && !isNaN(Ka) && (E < l && 0 < E) && (Va = AmCharts.line(e, fb, [E, E], ja, W, R), eb = AmCharts.line(e, gb, [E, E], ja, W, R));
								aa = G - P;
								la = new AmCharts.Cuboid(e, aa, K, x, y, wa, Ha, R, ja, W, I, p, n)
							}
						} else if (L = G - h / 2, M = N + R / 2, K = h, L + K > k && (K = k - L), 0 > L && (K += L, L = 0), aa = E - N, L < k && 0 < K) {
							var la = new AmCharts.Cuboid(e, K, aa, x, y, wa, Ma, R, ja, W, I, p, n),
								hb, ib;
							V > ia ? (hb = [E, Aa], ib = [N, za]) : (hb = [N, Aa], ib = [E, za]);
							!isNaN(Aa) && !isNaN(za) && (G < k && 0 < G) && (Va = AmCharts.line(e, [G, G], hb, ja, W, R), eb = AmCharts.line(e, [G, G], ib, ja, W, R))
						}
						la && (ra = la.set, Y.push(ra), ra.translate(L, M - R / 2), (H.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), Va && (Y.push(Va), Y.push(eb)), Z = G, ca = E, oa = G, pa = E, Q || (H.x = n ? M + K / 2 : L + K / 2, this.animateColumns(la, O, G, P, E, N), this.addListeners(ra, H)))
					}
					break;
				case "ohlc":
					if (!(isNaN(ia) || isNaN(cb) || isNaN(db) || isNaN(V))) {
						V < ia && (H.isNegative = !0, void 0 != ya && (qa = ya));
						var jb, kb, lb;
						if (n) {
							var mb = E - h / 2,
								mb = AmCharts.fitToBounds(mb, 0, l),
								tb = AmCharts.fitToBounds(E, 0, l),
								nb = E + h / 2,
								nb = AmCharts.fitToBounds(nb, 0, l);
							kb = AmCharts.line(e, [P, P], [mb, tb], qa, W, R, X);
							0 < E && E < l && (jb = AmCharts.line(e, [Ka, La], [E, E], qa, W, R, X));
							lb = AmCharts.line(e, [G, G], [tb, nb], qa, W, R, X)
						} else {
							var ob = G - h / 2,
								ob = AmCharts.fitToBounds(ob, 0, k),
								ub = AmCharts.fitToBounds(G, 0, k),
								pb = G + h / 2,
								pb = AmCharts.fitToBounds(pb, 0, k);
							kb = AmCharts.line(e, [ob, ub], [N, N], qa, W, R, X);
							0 < G && G < k && (jb = AmCharts.line(e, [G, G], [za, Aa], qa, W, R, X));
							lb = AmCharts.line(e, [ub, pb], [E, E], qa, W, R, X)
						}
						Y.push(kb);
						Y.push(jb);
						Y.push(lb);
				...
				if (!Q && !isNaN(V)) {
					...
					if (this.end - this.start <= vb || 0 === vb) {
						var Da = this.createBullet(H, oa, pa, O);
						Da || (Da = 0);
						var wb = this.labelText;
						if (wb) {
							var ba = this.createLabel(H, 0, 0, wb),
								xa = 0,
								Ba = 0,
								xb = ba.getBBox(),
								Wa = xb.width,
							...
							case "right":
								...
								break;
							case "bottom":
								n && "column" == g ? (Z = da, 0 > V ? (xa = -6, ba.attr({
									"text-anchor": "end"
								})) : (xa = 6, ba.attr({
									"text-anchor": "start"
								...
								break;
							case "middle":
								"column" == g && (n ? (Ba = -(Xa / 2) + this.fontSize / 2, xa = -(G - P) / 2 - x, 0 > aa && (xa += x), Math.abs(G - P) < Wa && !this.showAllValueLabels && (ba.remove(), ba = null)) : (Ba = -(E - N) / 2, 0 > aa && (Ba -= y), Math.abs(E - N) < Xa && !this.showAllValueLabels && (ba.remove(), ba = null)))
							}
							if (ba) {
						...
						if ("column" == g && "regular" == A || "100%" == A) {
							var zb = f.totalText;
							if (zb) {
								var Ea = this.createLabel(H, 0, 0, zb, f.totalTextColor);
								...
								var Ab = Ea.getBBox(),
									...
									Oa, Pa, Db = f.totals[O];
								Db && Db.remove();
								n ? (Pa = E, Oa = 0 > V ? G - Bb / 2 - 2 : G + Bb / 2 + 3) : (Oa = G, Pa = 0 > V ? E + Cb / 2 : E - Cb / 2 - 3);
								Ea.translate(Oa, Pa);
								f.totals[O] = Ea;
								n ? (0 > Pa || Pa > l) && Ea.remove() : (0 > Oa || Oa > k) && Ea.remove()
							}
						}
					}
				}
		...
		if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(q, t, ea, fa) : this.drawLineGraph(q, t, ea, fa), Q || this.launchAnimation();
	...
	drawLineGraph: function(a, b, c, d) {
		...
		if (1 < a.length) {
			...
			if (0 < f || 0 < t) if (l = a.join(";").split(";"), m = b.join(";").split(";"), "serial" == e.chartType && (0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), m = b.concat(d)) : e.rotate ? (m.push(m[m.length - 1]), l.push(u), m.push(m[0]), l.push(u), m.push(m[0]), l.push(l[0])) : (l.push(l[l.length - 1]), m.push(u), l.push(l[0]), m.push(u), l.push(a[0]), m.push(m[0]))), 0 < f && (a = AmCharts.polygon(g, l, m, p, f, 0, 0, 0, this.gradientRotation), h.push(a)), q || void 0 !== s) isNaN(t) && (t = f), q || (q = s), g = AmCharts.polygon(g, l, m, q, t, 0, 0, 0, this.gradientRotation), k.push(g), k.click(function() {
				e.handleGraphClick()
			});
			e.applyMask(k, h)
		}
	...
	drawSmoothedGraph: function(a, b, c, d) {
		if (1 < a.length) {
			...
			var k = this.lineAlpha,
				...
				q = this.baseCoord,
				t = new AmCharts.Bezier(f, a, b, this.lineColor, k, l, n, 0, e);
			g.push(t.path);
			void 0 !== r && (k = new AmCharts.Bezier(f, a, b, r, k, l, n, 0, e), h.push(k.path));
			0 < m && (l = a.join(";").split(";"), t = b.join(";").split(";"), k = "", 0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), t = b.concat(d)) : (this.rotate ? (k += " L" + q + "," + b[b.length - 1], k += " L" + q + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + q, k += " L" + a[0] + "," + q), k += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, l, t, NaN, 0, 0, n, m, e, k), g.push(c.path), p || void 0 !== r) && (s || (s = m), p || (p = r), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, p, s, e, k), h.push(a.path));
			this.applyMask(h, g)
		}
	},
	...
	createBullet: function(a, b, c, d) {
		...
		if ("none" != this.bullet || a.bullet) {
			...
			case "triangleLeft":
				...
				break;
			case "triangleRight":
				h = AmCharts.triangle(d, f, 90, n, r, g, l, m);
				break;
			case "bubble":
...
AmCharts.ChartCursor = AmCharts.Class({
	...
	createCursor: function() {
		...
		this.set.push(b);
		a ? (e && (g.pointerWidth = 0), "right" == d ? e ? g.setBounds(n, r + m, n + p + l, r + s + m) : g.setBounds(n + p + l + f, r + m, n + p + 1E3, r + s + m) : e ? g.setBounds(n, r, p + n, s + r) : g.setBounds(-1E3, -1E3, n - q - f, r + s + 15)) : (g.maxWidth = p, c.parseDates && (q = 0, g.pointerWidth = 0), "top" == d ? e ? g.setBounds(n + l, r + m, p + l + n, s + r) : g.setBounds(n + l, -1E3, p + l + n, r + m - q - f) : e ? g.setBounds(n, r, p + n, s + r - q) : g.setBounds(n, r + s + q + f - 1, n + p, r + s + q + f));
		this.hideCursor()
	},
		...
		if (this.enabled) {
			...
			if (r) {
				var p = r.x[f.id],
					...
					y = c.graphs,
					A = f.axisThickness;
				if (c.mouseIsOver || C || x || this.forceShow) if (this.forceShow = !1, x) {
					...
					0 !== d && (g = {
						type: "zoomed",
						target: this
					}, g.chart = this.chart, f.parseDates && !f.equalSpacing ? (c + d > w && (d = w - c), C + d < v && (d = v - C), g.start = C + d, g.end = c + d, this.fire(g.type, g)) : F + d >= this.data.length || 0 > k + d || (g.start = k + d, g.end = F + d, this.fire(g.type, g)))
				} else {
					"start" == B && (p -= f.cellWidth / 2);
					"mouse" == B && c.mouseIsOver && (p = s ? e - 2 : d - 2);
					if (s) {
						if (0 > p) if (C) p = 0;
						else {
							this.hideCursor();
					...
					0 < this.cursorAlpha && (v = this.line, s ? v.translate(0, p + h) : v.translate(p, 0), v.show());
					this.linePos = s ? p + h : p;
					C && (s ? this.updateSelectionSize(NaN, p) : this.updateSelectionSize(p, NaN));
					v = !0;
					C && (v = !1);
					this.categoryBalloonEnabled && v ? (s ? (q && ("right" == z ? u.setBounds(k, l + h, k + m + g, l + p + h) : u.setBounds(k, l + h, k + m + g, l + p)), "right" == z ? q ? u.setPosition(k + m + g, l + p + h) : u.setPosition(k + m + g + A, l + p + h) : q ? u.setPosition(k, l + p) : u.setPosition(k - A, l + p)) : "top" == z ? q ? u.setPosition(k + p + g, l + h) : u.setPosition(k + p + g, l + h - A + 1) : q ? u.setPosition(k + p, l + n) : u.setPosition(k + p, l + n + A - 1), (w = this.categoryBalloonFunction) ? u.showBalloon(w(r.category)) : f.parseDates ? (f = AmCharts.formatDate(r.category, this.categoryBalloonDateFormat), -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f, r.category)), u.showBalloon(f)) : u.showBalloon(r.category)) : u.hide();
					y && this.bulletsEnabled && this.showBullets();
					this.destroyValueBalloons();
					if (y && this.valueBalloonsEnabled && v && c.balloon.enabled) {
						this.valueBalloons = v = [];
						if (this.oneBalloonOnly) {
							h = Infinity;
							for (f = 0; f < y.length; f++) w = y[f], w.showBalloon && (!w.hidden && w.balloonText) && (t = r.axes[w.valueAxis.id].graphs[w.id], u = t.y, isNaN(u) || (s ? Math.abs(d - u) < h && (h = Math.abs(d - u), F = w) : Math.abs(e - u) < h && (h = Math.abs(e - u), F = w)));
							this.mostCloseGraph && (F = this.mostCloseGraph)
						}
						for (f = 0; f < y.length; f++) if (w = y[f], (!this.oneBalloonOnly || w == F) && (w.showBalloon && !w.hidden && w.balloonText) && (t = r.axes[w.valueAxis.id].graphs[w.id], u = t.y, !isNaN(u))) {
							q = t.x;
							p = !0;
							if (s) {
								if (h = u, 0 > q || q > n) p = !1
							} else if (h = q, q = u, 0 > h || h > m + g) p = !1;
							p && (p = w.valueBalloon, z = c.getBalloonColor(w, t), p.setBounds(k, l, k + m, l + n), p.pointerOrientation = "H", p.changeColor(z), void 0 !== w.balloonAlpha && (p.fillAlpha = w.balloonAlpha), void 0 !== w.balloonTextColor && (p.color = w.balloonTextColor), p.setPosition(h + k, q + l), h = c.formatString(w.balloonText, t, w), (q = w.balloonFunction) && (h = q(t, w)), "" !== h && p.showBalloon(h), !s && p.set && p.set.hide(), v.push({
								yy: u,
								balloon: p
							}))
						}
					...
					b ? (g = {
						type: "changed"
					}, g.index = a, g.target = this, g.chart = this.chart, g.zooming = C, g.mostCloseGraph = F, g.position = s ? e : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m) {
	...
	var q = 1 / 180 * Math.PI,
		...
		B = c + Math.sin((-d - e) * q) * g,
		z = b + Math.cos((d + e) * q) * h,
	...
	d = a.set();
	var y;
	p && (s = n(10 * s), u = n(10 * u), w = n(10 * w), z = n(10 * z), t = n(10 * t), v = n(10 * v), B = n(10 * B), q = n(10 * q), b = n(10 * b), k = n(10 * k), c = n(10 * c), f *= 10, g *= 10, h *= 10, r *= 10, 1 > Math.abs(e) && (1 >= Math.abs(w - u) && 1 >= Math.abs(B - v)) && (y = !0));
	e = "";
	if (0 < k) {
		p ? (path = " M" + s + "," + (t + k) + " L" + u + "," + (v + k), y || (path += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + u + "," + (v + k) + "," + w + "," + (B + k)), path += " L" + z + "," + (q + k), 0 < h && (y || (path += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) + "," + z + "," + (k + q) + "," + s + "," + (k + t)))) : (path = " M" + s + "," + (t + k) + " L" + u + "," + (v + k), path += " A" + f + "," + g + ",0," + x + ",1," + w + "," + (B + k) + " L" + z + "," + (q + k), 0 < h && (path += " A" + h + "," + r + ",0," + x + ",0," + s + "," + (t + k)));
		path += " Z";
		var A = a.path(path, void 0, void 0, "1000,1000").attr(C);
		d.push(A);
		A = a.path(" M" + s + "," + t + " L" + s + "," + (t + k) + " L" + u + "," + (v + k) + " L" + u + "," + v + " L" + s + "," + t + " Z", void 0, void 0, "1000,1000").attr(C);
		k = a.path(" M" + w + "," + B + " L" + w + "," + (B + k) + " L" + z + "," + (q + k) + " L" + z + "," + q + " L" + w + "," + B + " Z", void 0, void 0, "1000,1000").attr(C);
		d.push(A);
		d.push(k)
	}
	p ? (y || (e = " A" + n(b - f) + "," + n(c - g) + "," + n(b + f) + "," + n(c + g) + "," + n(u) + "," + n(v) + "," + n(w) + "," + n(B)), f = " M" + n(s) + "," + n(t) + " L" + n(u) + "," + n(v) + e + " L" + n(z) + "," + n(q)) : f = " M" + s + "," + t + " L" + u + "," + v + (" A" + f + "," + g + ",0," + x + ",1," + w + "," + B) + " L" + z + "," + q;
	0 < h && (p ? y || (f += " B" + (b - h) + "," + (c - r) + "," + (b + h) + "," + (c + r) + "," + z + "," + q + "," + s + "," + t) : f += " A" + h + "," + r + ",0," + x + ",0," + s + "," + t);
...
AmCharts.AmPieChart = AmCharts.Class({
	...
	drawChart: function() {
		...
		if (AmCharts.ifArray(b)) {
			if (0 < a.realWidth && 0 < a.realHeight) {
				...
				a.chartDataLabels = [];
				a.ticks = [];
				var n, r, p, s = AmCharts.toNumber(a.labelRadius),
					q = a.measureMaxLabel();
				...
				for (m = 0; m < b.length; m++) if (e = b[m], !0 !== e.hidden && 0 < e.percents) {
					var k = 360 * -e.percents / 100,
						...
						t = Math.sin((-f - k / 2) / 180 * Math.PI) * (l / p),
						h = {
							fill: e.color,
					...
					h = AmCharts.wedge(d, n, r, f, k, p, l, g, a.depth3D, h, a.gradientRatio);
					...
					if (a.labelsEnabled && a.labelText && e.percents >= a.hideLabelsPercent) {
						...
						if (0 <= k) {
							var B;
							90 >= v && 0 <= v ? (B = 0, w = "start", u = 8) : 360 >= v && 270 < v ? (B = 1, w = "start", u = 8) : 270 >= v && 180 < v ? (B = 2, w = "end", u = -8) : 180 >= v && 90 < v && (B = 3, w = "end", u = -8);
							e.labelQuarter = B
						} else w = "middle";
						var v = a.formatString(a.labelText, e),
							z = e.labelColor;
						void 0 == z && (z = a.color);
						v = AmCharts.text(d, v, z, a.fontFamily, a.fontSize, w);
						v.translate(q + 1.5 * u, t);
						e.tx = q + 1.5 * u;
						e.ty = t;
	...
	checkOverlapping: function(a, b, c, d, e) {
		var f, g, h = this.chartData,
			...
			l = b.label;
		if (l) {
			if (!0 === d) for (g = a + 1; g < k; g++)(f = this.checkOverlappingReal(b, h[g], c)) && (g = k);
...
AmCharts.AmStockChart = AmCharts.Class({
	...
	createLayout: function() {
		...
		if ("right" == b || "right" == c) b = document.createElement("div"), b.style.cssFloat = "right", b.style.styleFloat = "right", b.style.width = "0px", a.appendChild(b), this.rightContainer = b;
	...
	measurePanels: function() {
		...
		for (e = 0; e < a.length; e++) f = a[e], f.percentHeight = 100 * (f.percentHeight / d), f.panelBox && (f.panelBox.style.height = Math.round(f.percentHeight * this.panelsHeight / 100) + "px")
	},
	...
	zoomChart: function(a, b) {
		...
		if (d && e) {
			...
			b || (b = e);
			if (f) {
				var s = AmCharts.extractPeriod(f);
				a.getTime() == b.getTime() && s != h && (b = AmCharts.changeDate(b, s.period, s.count), b.setTime(b.getTime() - 1))
			}
			...
			for (d = 0; d < m.length; d++) {
				...
				if (f != e) {
					...
					for (q = 0; q < n.length; q++) {
						var t = n[q].graph;
						t.dataProvider = t.dataSet.agregatedDataProviders[f]
					}
					q = s.categoryAxis;
					q.firstDayOfWeek = p;
					q.minPeriod = f;
					s.dataProvider = c.mainDataSet.agregatedDataProviders[f];
					if (q = s.chartCursor) q.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(g.period), s.showCategoryAxis || (q.categoryBalloonEnabled = !1);
					s.startTime = h.getTime();
					s.endTime = b.getTime();
					s.validateData(!0)
				}
				q = !1;
				s.chartCursor && s.chartCursor.panning && (q = !0);
				q || (s.startTime = void 0, s.endTime = void 0, s.zoomToDates(h, b));
				0 < k.startDuration && c.animationPlayed ? (s.startDuration = 0, s.animateAgain()) : 0 < k.startDuration && s.animateAgain()
			}
			c.animationPlayed = !0;
			AmCharts.extractPeriod(f);
			k = new Date(b);
			r && c.updateScrollbar && (r.zoomToDates(a, k), c.skipScrollbarEvent = !0, setTimeout(function() {
				c.resetSkip.call(c)
			}, 100));
			c.updateScrollbar = !0;
			c.startDate = a;
			c.endDate = b;
			l && l.zoom(a, b);
			if (a.getTime() != c.previousStartDate.getTime() || b.getTime() != c.previousEndDate.getTime()) l = {
				type: "zoomed"
			}, l.startDate = a, l.endDate = b, l.chart = c, l.period = f, c.fire(l.type, l), c.previousStartDate = new Date(a), c.previousEndDate = new Date(b)
		}
		c.eventsHidden && c.showHideEvents(!1);
		c.chartCreated || (f = "init", c.fire(f, {
			type: f,
			chart: c
		}));
		c.chartRendered || (f = "rendered", c.fire(f, {
			type: f,
			chart: c
		}), c.chartRendered = !0);
		c.chartCreated = !0;
		...
		if (0 < this.dataSets.length) {
			...
			for (b = 0; b < a.length; b++) {
				...
				for (g = 0; g < f.length; g++) {
					...
					if (h.comparable) {
						var r = e.length;
						0 < r && (h.valueAxis.logarithmic && "never" != c.recalculateToPercents) && (h.valueAxis.logarithmic = !1, h.valueAxis.prevLog = !0);
						0 < r && "whenComparing" == c.recalculateToPercents && (h.valueAxis.recalculateToPercents = !0);
						l && h.valueAxis && !0 === h.valueAxis.recalculateToPercents && (k = !0);
						var p;
						for (p = 0; p < r; p++) {
							var s = e[p],
								q = h.comparedGraphs[s.id];
							q || (q = new AmCharts.AmGraph, q.id = "comparedGraph" + p + "_" + s.id);
							q.periodValue = h.periodValue;
							q.dataSet = s;
							h.comparedGraphs[s.id] = q;
							q.seriesIdField = "amCategoryIdField";
							q.connect = h.connect;
							var t = h.compareField;
							t || (t = h.valueField);
							var u = !1,
								v = s.fieldMappings,
								w;
							for (w = 0; w < v.length; w++) v[w].toField == t && (u = !0);
							if (u) {
								q.valueField = t;
								q.title = s.title;
								q.lineColor = s.color;
								h.compareGraphType && (q.type = h.compareGraphType);
								t = h.compareGraphLineThickness;
								isNaN(t) || (q.lineThickness = t);
								t = h.compareGraphDashLength;
								isNaN(t) || (q.dashLength = t);
								t = h.compareGraphLineAlpha;
								isNaN(t) || (q.lineAlpha = t);
								t = h.compareGraphCornerRadiusTop;
								isNaN(t) || (q.cornerRadiusTop = t);
								t = h.compareGraphCornerRadiusBottom;
								isNaN(t) || (q.cornerRadiusBottom = t);
								t = h.compareGraphBalloonColor;
								isNaN(t) || (q.balloonColor = t);
								if (t = h.compareGraphFillColors) q.fillColors = t;
								if (t = h.compareGraphNegativeFillColors) q.negativeFillColors = t;
								if (t = h.compareGraphFillAlphas) q.fillAlphas = t;
								if (t = h.compareGraphNegativeFillAlphas) q.negativeFillAlphas = t;
								if (t = h.compareGraphBullet) q.bullet = t;
								if (t = h.compareGraphNumberFormatter) q.numberFormatter = t;
								if (t = h.compareGraphBalloonText) q.balloonText = t;
								t = h.compareGraphBulletSize;
								isNaN(t) || (q.bulletSize = t);
								t = h.compareGraphBulletAlpha;
								isNaN(t) || (q.bulletAlpha = t);
								q.visibleInLegend = h.compareGraphVisibleInLegend;
								q.valueAxis = h.valueAxis;
								l && (k && m ? q.legendValueText = m : n && (q.legendValueText = n));
								c.addGraph(q);
	...
	choosePeriod: function(a, b, c) {
		var d = this.categoryAxesSettings,
			...
			e = e[a + 1],
			g = AmCharts.extractPeriod(f),
			g = AmCharts.getPeriodDuration(g.period, g.count),
			h = b.getTime(),
			k = c.getTime(),
			d = d.maxSeries;
...
AmCharts.PeriodSelector = AmCharts.Class({
	...
	write: function(a) {
		...
		if (b.inputFieldsEnabled) {
			...
			f.appendChild(h);
			b.startDateField = h;
			if (c) g = b.width - 6 + "px", AmCharts.addBr(f);
			else {
	...
	selectPeriodButton: function(a, b) {
		var c = a.button,
			d = c.count,
			e = c.period,
			f, g, h = this.firstDate,
			k = this.lastDate,
			l;
		h && k && ("MAX" == e ? (f = h, g = k) : "YTD" == e ? (f = new Date, f.setMonth(0, 1), f.setHours(0, 0, 0, 0), 0 === d && f.setDate(f.getDate() - 1), g = this.lastDate) : (l = AmCharts.getPeriodDuration(e, d), this.selectFromStart ? (f = h, g = new Date(h.getTime() + l)) : (f = new Date(k.getTime() - l), g = k)), a.startTime = f.getTime(), this.hideOutOfScopePeriods && (b && a.startTime < h.getTime() ? c.style.display = "none" : c.style.display = "inline"), f.getTime() > k.getTime() && (l = AmCharts.getPeriodDuration("DD", 1), f = new Date(k.getTime() - l)), f.getTime() < h.getTime() && (f = h), "YTD" == e && (a.startTime = f.getTime()), a.endTime = g.getTime(), b || (this.skipMark = !0, this.unselectButtons(), c.className = "amChartsButtonSelected", c = {
			type: "changed"
		}, c.startDate = f, c.endDate = g, c.predefinedPeriod = e, c.chart = this.chart, c.count = d, this.fire(c.type, c)))
	},
...
AmCharts.StockPanel = AmCharts.Class({
	...
	handleDraw: function(a) {
		...
		g.finalValue = b.coordinateToValue(a);
...
AmCharts.parseStockData = function(a, b, c, d) {
	...
	var e = {},
		...
		g = a.categoryField;
	if (g) {
		var h = AmCharts.getItemIndex(b, c),
			k = c.length,
			l, m = f.length,
			n, r = {};
		...
		for (l = 0; l < m; l++) {
			var t = f[l],
				u = t[g],
				u = u instanceof Date ? "fff" == b ? AmCharts.useUTC ? new Date(u.getUTCFullYear(), u.getUTCMonth(), u.getUTCDate(), u.getUTCHours(), u.getUTCMinutes(), u.getUTCSeconds(), u.getUTCMilliseconds()) : new Date(u.getFullYear(), u.getMonth(), u.getDate(), u.getHours(), u.getMinutes(), u.getSeconds(), u.getMilliseconds()) : new Date(u) : new Date(u),
				v = u.getTime(),
				w = {};
			for (n = 0; n < q; n++) w[s[n].toField] = t[s[n].fromField];
			var B;
			for (B = h; B < k; B++) {
				n = c[B];
				var z = AmCharts.extractPeriod(n),
					C = z.period,
					z = z.count;
				if (B == h || v >= r[n] || !r[n]) {
					p[n] = {};
					p[n][g] = new Date(u);
					p[n].amCategoryIdField = String(AmCharts.resetDateToMin(u, C, z, d).getTime());
					var x;
					for (x = 0; x < q; x++) {
						var y = p[n],
							A = s[x].toField,
						...
						y[A + "Count"] = 0;
						y[A + "Sum"] = 0;
						isNaN(F) || (y[A + "Open"] = F, y[A + "Sum"] = F, y[A + "High"] = F, y[A + "Low"] = F, y[A + "Close"] = F, y[A + "Count"] = 1, y[A + "Average"] = F)
					}
					e[n].push(p[n]);
					B > h && (y = new Date(u), y = AmCharts.changeDate(y, C, z, !0), y = AmCharts.resetDateToMin(y, C, z, d), r[n] = y.getTime());
					if (B == h) for (var J in t) t.hasOwnProperty(J) && (p[n][J] = t[J])
				} else for (C = 0; C < q; C++) A = s[C].toField, y = p[n], l == m - 1 && (y[g] = new Date(u)), F = Number(w[A]), isNaN(F) || (isNaN(y[A + "Low"]) && (y[A + "Low"] = F), F < y[A + "Low"] && (y[A + "Low"] = F), isNaN(y[A + "High"]) && (y[A + "High"] = F), F > y[A + "High"] && (y[A + "High"] = F), y[A + "Close"] = F, y[A + "Sum"] += F, y[A + "Count"]++, y[A + "Average"] = y[A + "Sum"] / y[A + "Count"])
			}
		}
	}
...
AmCharts.parseEvents = function(a, b, c, d, e) {
	var f = a.stockEvents,
		...
		h = b.length,
		k, l, m, n, r, p, s;
	for (k = 0; k < h; k++) for (p = b[k], r = p.graphs, m = r.length, l = 0; l < m; l++) n = r[l], n.customBulletField = "amCustomBullet" + n.id + "_" + p.id, n.bulletConfigField = "amCustomBulletConfig" + n.id + "_" + p.id;
	for (var q in g) if (g.hasOwnProperty(q)) {
		var t = g[q],
			u = AmCharts.extractPeriod(q),
			v = t.length,
			w;
		for (w = 0; w < v; w++) {
			var B = t[w];
			...
			m = u.count;
			var C;
			C = "fff" == l ? k.getTime() + 1 : AmCharts.resetDateToMin(AmCharts.changeDate(new Date(k), u.period, u.count), l, m, d).getTime();
			for (k = 0; k < h; k++) for (p = b[k], r = p.graphs, m = r.length, l = 0; l < m; l++) {
				n = r[l];
				var x = {};
				x.eventDispatcher = e;
				x.eventObjects = [];
...
AmCharts.DataSetSelector = AmCharts.Class({
	...
	write: function(a) {
		...
		if (1 < b.countDataSets("showInSelect")) {
			...
			for (c = 0; c < d.length; c++) if (g = d[c], !0 === g.showInSelect) {
...
AmCharts.StackedBullet = AmCharts.Class({
	...
	addLetter: function(a, b, c) {
		...
		var g = 0,
			...
			n = this.shape,
			r = this.textColor;
		void 0 !== this.color && (r = this.color);
		void 0 === a && (a = "");
		a = AmCharts.text(d, a, r, this.chart.fontFamily, this.fontSize);
		d = a.getBBox();
		this.labelWidth = r = d.width;
		...
		this.bullets[c] = l;
		this.showOnAxis ? (l = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY, k = g * e, this.nextAxisY = l + e * d) : (l = this.nextY, k = g * e);
		a.translate(h, k);
		b.push(a);
		b.translate(0, l);
	...
	drawSign: function(a) {
		...
		var c = this.mastHeight * b,
			...
			f = AmCharts.circle(this.container, d, this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
		f.translate(0, c + d * b);
		a.push(e);
		a.push(f);
		this.set.push(a);
